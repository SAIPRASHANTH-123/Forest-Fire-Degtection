...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("vtu19684@veltech.edu.in", 'Pandu@123') # Senders mail ID and password
        server.sendmail('allanisaiprashanth@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
